...
public class UnitSpinnerAdapter extends ArrayAdapter<CategorySpinner> {

    public UnitSpinnerAdapter(@NonNull Context context, int resource, @NonNull List<CategorySpinner> objects) {
